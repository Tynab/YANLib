...
public partial class YANObjectTest
{
    ...
    #region IsExistItem
    [Fact]
    public void IsExistItem_NullIEnumerable_ReturnsFalse()
    {
        // Arrange
        IEnumerable<int>? input = null;

        // Act
        var result = input.IsExistItem();
    ...
    [Fact]
    public void IsExistItem_EmptyIEnumerable_ReturnsFalse()
    {
        // Arrange
        IEnumerable<int> input = [];
    ...
    [Fact]
    public void IsExistItem_NonEmptyIEnumerable_ReturnsTrue()
    {
        // Arrange
    ...
    #region IsExistItem
    [Fact]
    public void IsNotExistItem_NullIEnumerable_ReturnsTrue()
    {
        // Arrange
        IEnumerable<string>? input = null;

        // Act
        var result = input.IsNotExistItem();
    ...
    [Fact]
    public void IsNotExistItem_EmptyIEnumerable_ReturnsTrue()
    {
        // Arrange
    ...
    [Fact]
    public void IsNotExistItem_NonEmptyIEnumerable_ReturnsFalse()
    {
        // Arrange
        IEnumerable<string> input = ["a", "b"];
