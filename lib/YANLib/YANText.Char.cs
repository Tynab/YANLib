...
public static partial class YANText
{
    ...
    public static bool IsNullOrEmpty(params char[] cs) => cs is not null && !cs.Any(c => c.HasValue());
    ...
    public static bool IsNullOrEmpty(this IEnumerable<char> cs) => cs is not null && !cs.Any(c => c.HasValue());
    ...
    public static bool IsNullOrEmpty(this IReadOnlyCollection<char> cs) => cs is not null && !cs.Any(c => c.HasValue());
    ...
    public static bool IsNullOrEmpty(this IReadOnlyList<char> cs) => cs is not null && !cs.Any(c => c.HasValue());
    ...
    public static bool IsNullOrEmpty(this IReadOnlySet<char> cs) => cs is not null && !cs.Any(c => c.HasValue());
    ...
    public static bool IsNullOrWhiteSpace(params char[] cs) => cs is not null && !cs.Any(c => c.HasCharater());
    ...
    public static bool IsNullOrWhiteSpace(this IEnumerable<char> cs) => cs is not null && !cs.Any(c => c.HasCharater());
    ...
    public static bool IsNullOrWhiteSpace(this IReadOnlyCollection<char> cs) => cs is not null && !cs.Any(c => c.HasCharater());
    ...
    public static bool IsNullOrWhiteSpace(this IReadOnlyList<char> cs) => cs is not null && !cs.Any(c => c.HasCharater());
    ...
    public static bool IsNullOrWhiteSpace(this IReadOnlySet<char> cs) => cs is not null && !cs.Any(c => c.HasCharater());
    ...
    public static bool HasValue(params char[] cs) => cs is not null && !cs.Any(c => c.IsNullOrEmpty());
    ...
    public static bool HasValue(this IEnumerable<char> cs) => cs is not null && !cs.Any(c => c.IsNullOrEmpty());
    ...
    public static bool HasValue(this IReadOnlyCollection<char> cs) => cs is not null && !cs.Any(c => c.IsNullOrEmpty());
    ...
    public static bool HasValue(this IReadOnlyList<char> cs) => cs is not null && !cs.Any(c => c.IsNullOrEmpty());
    ...
    public static bool HasValue(this IReadOnlySet<char> cs) => cs is not null && !cs.Any(c => c.IsNullOrEmpty());
    ...
    public static bool HasCharater(params char[] cs) => cs is not null && !cs.Any(c => c.IsNullOrWhiteSpace());
    ...
    public static bool HasCharater(this IEnumerable<char> cs) => cs is not null && !cs.Any(c => c.IsNullOrWhiteSpace());
    ...
    public static bool HasCharater(this IReadOnlyCollection<char> cs) => cs is not null && !cs.Any(c => c.IsNullOrWhiteSpace());
    ...
    public static bool HasCharater(this IReadOnlyList<char> cs) => cs is not null && !cs.Any(c => c.IsNullOrWhiteSpace());
    ...
    public static bool HasCharater(this IReadOnlySet<char> cs) => cs is not null && !cs.Any(c => c.IsNullOrWhiteSpace());
