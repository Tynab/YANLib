...
public static partial class YANBytes
{
    ...
    public static IEnumerable<byte[]?> ToByteArrays(this IEnumerable<object?>? input)
    {
    ...
    /// <returns>An enumerable collection of byte arrays representing each object's byte array representation.</returns>
    public static IEnumerable<byte[]?> ToByteArrays(this ICollection<object?>? input)
    {
        if (input.IsNullOEmpty())
        {
            yield break;
    ...
    /// <returns>An enumerable collection of byte arrays representing each object's byte array representation.</returns>
    public static IEnumerable<byte[]?> ToByteArrays(this object?[]? input)
    {
        if (input.IsNullOEmpty())
        {
            yield break;
    ...
    /// </summary>
    /// <param name="input">The collection of byte arrays to be converted. Can be <see langword="null"/>.</param>
    ...
    public static IEnumerable<T?> FromByteArrays<T>(this IEnumerable<byte[]?>? input)
    {
        if (input.IsNullOEmpty())
        {
            yield break;
        ...
        foreach (var item in input)
        {
            yield return item.FromByteArray<T>();
        }
    }
    ...
    /// if conversion fails or the byte array is <see langword="null"/>, a <see langword="null"/> value of type <typeparamref name="T"/> is yielded.
    /// </summary>
    /// <param name="input">The ICollection of byte arrays to be converted. Can be <see langword="null"/>.</param>
    /// <returns>An enumerable collection of objects of type <typeparamref name="T"/> representing the deserialized results from the byte arrays.</returns>
    public static IEnumerable<T?> FromByteArrays<T>(this ICollection<byte[]?>? input)
    {
        if (input.IsNullOEmpty())
        {
            yield break;
    ...
    /// if conversion fails or the byte array is <see langword="null"/>, a <see langword="null"/> value of type <typeparamref name="T"/> is yielded.
    /// </summary>
    /// <param name="input">The array of byte arrays to be converted. Can be <see langword="null"/>.</param>
    /// <returns>An enumerable collection of objects of type <typeparamref name="T"/> representing the deserialized results from the byte arrays.</returns>
    public static IEnumerable<T?> FromByteArrays<T>(this byte[]?[]? input)
    {
        if (input.IsNullOEmpty())
        {
            yield break;
