...
public static partial class YANText
{
    ...
    public static bool IsNullOrEmpty(params string[] strs) => strs is not null && !strs.Any(s => s.HasValue());
    ...
    public static bool IsNullOrEmpty(this IEnumerable<string> strs) => strs is not null && !strs.Any(s => s.HasValue());
    ...
    public static bool IsNullOrEmpty(this IReadOnlyCollection<string> strs) => strs is not null && !strs.Any(s => s.HasValue());
    ...
    public static bool IsNullOrEmpty(this IReadOnlyList<string> strs) => strs is not null && !strs.Any(s => s.HasValue());
    ...
    public static bool IsNullOrEmpty(this IReadOnlySet<string> strs) => strs is not null && !strs.Any(s => s.HasValue());
    ...
    /// <param name="str">The string to check.</param>
    /// <returns><see langword="true"/> if the string is <see langword="null"/>, <see cref="string.Empty"/>, or consists only of white-space characters; otherwise, <see langword="false"/>.</returns>
    public static bool IsNullOrWhiteSpace(params string[] strs) => strs is not null && !strs.Any(s => s.HasCharater());
    ...
    public static bool IsNullOrWhiteSpace(this IEnumerable<string> strs) => strs is not null && !strs.Any(s => s.HasCharater());
    ...
    public static bool IsNullOrWhiteSpace(this IReadOnlyCollection<string> strs) => strs is not null && !strs.Any(s => s.HasCharater());
    ...
    public static bool IsNullOrWhiteSpace(this IReadOnlyList<string> strs) => strs is not null && !strs.Any(s => s.HasCharater());
    ...
    public static bool IsNullOrWhiteSpace(this IReadOnlySet<string> strs) => strs is not null && !strs.Any(s => s.HasCharater());
    ...
    public static bool HasValue(params string[] strs) => strs is not null && !strs.Any(s => s.IsNullOrEmpty());
    ...
    public static bool HasValue(this IEnumerable<string> strs) => strs is not null && !strs.Any(s => s.IsNullOrEmpty());
    ...
    public static bool HasValue(this IReadOnlyCollection<string> strs) => strs is not null && !strs.Any(s => s.IsNullOrEmpty());
    ...
    public static bool HasValue(this IReadOnlyList<string> strs) => strs is not null && !strs.Any(s => s.IsNullOrEmpty());
    ...
    public static bool HasValue(this IReadOnlySet<string> strs) => strs is not null && !strs.Any(s => s.IsNullOrEmpty());
    ...
    public static bool HasCharater(params string[] strs) => strs is not null && !strs.Any(s => s.IsNullOrWhiteSpace());
    ...
    public static bool HasCharater(this IEnumerable<string> strs) => strs is not null && !strs.Any(s => s.IsNullOrWhiteSpace());
    ...
    public static bool HasCharater(this IReadOnlyCollection<string> strs) => strs is not null && !strs.Any(s => s.IsNullOrWhiteSpace());
    ...
    public static bool HasCharater(this IReadOnlyList<string> strs) => strs is not null && !strs.Any(s => s.IsNullOrWhiteSpace());
    ...
    public static bool HasCharater(this IReadOnlySet<string> strs) => strs is not null && !strs.Any(s => s.IsNullOrWhiteSpace());
