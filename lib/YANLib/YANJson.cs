...
public static partial class YANJson
{
    ...
    public static string? StandardSerialize(this object? val, JsonSerializerOptions? options = null) => val is null
        ? default
        : options is null
    ...
    /// <param name="options">The options to control the behavior of the JsonSerializer. Can be <see langword="null"/>.</param>
    /// <returns>A JSON string representation of the object, or <see langword="null"/> if the object is <see langword="null"/>.</returns>
    public static string? Serialize(this object? val, JsonSerializerOptions? options = null) => val is null
        ? default
        : options is null
    ...
    /// <summary>
    /// Deserializes the JSON string into an object of type <typeparamref name="T"/> using the provided JsonSerializerOptions.
    /// Returns the default value of <typeparamref name="T"/> if the JSON string is null, white-space, or if deserialization fails.
    /// Uses default deserialization settings if no JsonSerializerOptions are provided.
    /// </summary>
    /// <param name="json">The JSON string to be deserialized. Can be <see langword="null"/> or white-space.</param>
    /// <param name="options">The options to control the behavior of the JsonSerializer. Can be <see langword="null"/>.</param>
    /// <returns>An object of type <typeparamref name="T"/> deserialized from the JSON string, or the default value of <typeparamref name="T"/> if deserialization fails.</returns>
    public static T? StandardDeserialize<T>(this string? json, JsonSerializerOptions? options = null)
    {
        try
        {
            return json.IsWhiteSpaceOrNull() ? default : options is null ? JsonSerializer.Deserialize<T>(json) : JsonSerializer.Deserialize<T>(json, options);
        }
        catch
        {
            return default;
    ...
    /// <summary>
    /// Deserializes the JSON string into an object of type <typeparamref name="T"/> using the provided JsonSerializerOptions, with a default case-insensitive property name policy.
    /// Returns the default value of <typeparamref name="T"/> if the JSON string is null, white-space, or if deserialization fails.
    ...
    public static T? Deserialize<T>(this string? json, JsonSerializerOptions? options = null)
    {
        try
        {
            return json.IsWhiteSpaceOrNull() ? default : options is null ? JsonSerializer.Deserialize<T>(json, IsPropertyNameCaseInsensitive) : JsonSerializer.Deserialize<T>(json, options);
        }
        catch
        {
            return default;
    ...
    public static T? Deserialize<T>(this byte[]? utf8Json, JsonSerializerOptions? options = null)
    {
        try
        {
            return utf8Json is null ? default : options is null ? JsonSerializer.Deserialize<T>(utf8Json, IsPropertyNameCaseInsensitive) : JsonSerializer.Deserialize<T>(utf8Json, options);
        }
        catch
        {
            return default;
