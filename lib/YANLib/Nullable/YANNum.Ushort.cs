...
public static partial class YANNum
{
    ...
    public static IEnumerable<ushort?> ToUshort(params string[] strs)
    {
    ...
    /// <param name="strs">The enumerable of strings to be converted.</param>
    /// <returns>An <see cref="IEnumerable{ushort}"/> containing the ushort representations of the strings.</returns>
    public static IEnumerable<ushort?> ToUshort(this IReadOnlyCollection<string> strs)
    {
    ...
    /// <param name="strs">The enumerable of strings to be converted.</param>
    /// <returns>An <see cref="IEnumerable{ushort}"/> containing the ushort representations of the strings.</returns>
    public static IEnumerable<ushort?> ToUshort(this IReadOnlyList<string> strs)
    {
        if (strs is null || strs.Count < 1)
        {
            yield break;
    ...
    /// <param name="strs">The enumerable of strings to be converted.</param>
    /// <returns>An <see cref="IEnumerable{ushort}"/> containing the ushort representations of the strings.</returns>
    public static IEnumerable<ushort?> ToUshort(this IReadOnlySet<string> strs)
    {
        if (strs is null || strs.Count < 1)
        {
            yield break;
    ...
    public static ushort? GenerateRandomUshort<T1, T2>(T1 min, T2 max) where T1 : struct where T2 : struct
    {
        ...
        return minValue.HasValue && maxValue.HasValue ? minValue > maxValue ? default : new Random().Next(minValue.Value, maxValue.Value).ToUshort() : default;
    }
