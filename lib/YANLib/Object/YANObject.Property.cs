...
public static partial class YANObject
{
    ...
    public static bool AllPropertiesNotDefaults<T>(this IEnumerable<T>? input) where T : class => input.IsNotNullNEmpty() && !input.Any(x => x.AnyPropertiesDefault());

    public static bool AllPropertiesNotDefaults<T>(this ICollection<T>? input) where T : class => input.IsNotNullNEmpty() && !input.Any(x => x.AnyPropertiesDefault());

    public static bool AllPropertiesNotDefaults<T>(params T[]? input) where T : class => input.IsNotNullNEmpty() && !input.Any(x => x.AnyPropertiesDefault());
    ...
    public static bool AllPropertiesDefaults<T>(this IEnumerable<T>? input) where T : class => input.IsNotNullNEmpty() && !input.Any(x => x.AnyPropertiesNotDefault());

    public static bool AllPropertiesDefaults<T>(this ICollection<T>? input) where T : class => input.IsNotNullNEmpty() && !input.Any(x => x.AnyPropertiesNotDefault());

    public static bool AllPropertiesDefaults<T>(params T[]? input) where T : class => input.IsNotNullNEmpty() && !input.Any(x => x.AnyPropertiesNotDefault());
    ...
    public static bool AnyPropertiesNotDefaults<T>(this IEnumerable<T>? input) where T : class => input.IsNotNullNEmpty() && input.Any(x => x.AnyPropertiesNotDefault());

    public static bool AnyPropertiesNotDefaults<T>(this ICollection<T>? input) where T : class => input.IsNotNullNEmpty() && input.Any(x => x.AnyPropertiesNotDefault());

    public static bool AnyPropertiesNotDefaults<T>(params T[]? input) where T : class => input.IsNotNullNEmpty() && input.Any(x => x.AnyPropertiesNotDefault());
    ...
    public static bool AnyPropertiesDefaults<T>(this IEnumerable<T>? input) where T : class => input.IsNotNullNEmpty() && input.Any(x => x.AnyPropertiesDefault());

    public static bool AnyPropertiesDefaults<T>(this ICollection<T>? input) where T : class => input.IsNotNullNEmpty() && input.Any(x => x.AnyPropertiesDefault());

    public static bool AnyPropertiesDefaults<T>(params T[]? input) where T : class => input.IsNotNullNEmpty() && input.Any(x => x.AnyPropertiesDefault());

    public static bool AllPropertiesNotDefault<T>(this T input, params string?[]? names) where T : class
    {
        if (input.IsNull() || names.IsNullOEmpty() || names.AllNullOWhiteSpace())
        {
            return default;
        }
    ...
    public static bool AllPropertiesNotDefaults<T>(this IEnumerable<T>? input, params string?[]? names) where T : class
        => input.IsNotNullNEmpty() && names.IsNotNullNEmpty() && names.AllNotNullNWhiteSpace() && !input.Any(x => x.AnyPropertiesDefault(names));
    ...
    public static bool AllPropertiesDefaults<T>(this IEnumerable<T>? input, params string?[]? names) where T : class
        => input.IsNotNullNEmpty() && names.IsNotNullNEmpty() && names.AllNotNullNWhiteSpace() && !input.Any(x => x.AnyPropertiesNotDefault(names));
