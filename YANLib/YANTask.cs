...
public static partial class YANTask
{
    ...
    /// The result of the operation is the <typeparamref name="T"/> value of the completed task that matches the specified condition, or <c>null</c> if no such task completed successfully.
    /// </returns>
