...
public static partial class YANNum
{
    ...
    /// <param name="dfltVal">The default value to be returned if the parsing fails, or <see langword="default"/> if it is null.</param>
    /// <returns>The parsed <see cref="byte"/> value, or the specified default value if the parsing fails, or <see langword="default"/> if the specified default value is null.</returns>
