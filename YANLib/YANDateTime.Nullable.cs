...
{
    /// <summary>
    /// Parses the string representation of a date and time using <paramref name="fmt"/>. Returns the parsed <see cref="DateTime"/> value, or <paramref name="dfltVal"/> if the parsing fails. If <paramref name="dfltVal"/> is not specified, returns the current date instead.
    /// </summary>
    ...
    /// <summary>
    /// Generates a random <see cref="DateTime"/> value between <paramref name="min"/> and <paramref name="max"/>. If <paramref name="min"/> is greater than <paramref name="max"/> or <paramref name="min"/> is <see langword="null"/>, <see cref="Today"/> is returned.
    /// </summary>
    ...
    /// <summary>
    /// Generates a random <see cref="DateTime"/> value between <paramref name="min"/> and <paramref name="max"/>. If both <paramref name="min"/> and <paramref name="max"/> are <see langword="null"/>, <see cref="Today"/> is returned. If only <paramref name="min"/> is <see langword="null"/>, a random date is generated between <see cref="MinValue"/> and <paramref name="max"/>. If only <paramref name="max"/> is <see langword="null"/>, a random date is generated between <paramref name="min"/> and <see cref="Today"/>.
    /// </summary>
    /// <param name="min">The minimum <see cref="DateTime"/> value.</param>
    /// <param name="max">The maximum <see cref="DateTime"/> value.</param>
    /// <returns>A random <see cref="DateTime"/> value between <paramref name="min"/> and <paramref name="max"/>.</returns>
    ...
    /// <summary>
    /// Returns the week of the year that the specified <see cref="DateTime"/> value falls in, according to the current culture's calendar, week rule, and first day of the week settings. If the input value is <see langword="null"/>, 0 is returned.
    /// </summary>
    ...
    /// <param name="dt">The nullable <see cref="DateTime"/> value to convert.</param>
    /// <param name="tzSrc">The time zone offset of the original <see cref="DateTime"/> value, in hours. If <see langword="null"/>, the local time zone is used.</param>
    /// <param name="tzDst">The time zone offset to convert the original nullable <see cref="DateTime"/> value to, in hours. If <see langword="null"/>, the original nullable <paramref name="dt"/> is returned as-is. If <paramref name="tzSrc"/> is also <see langword="null"/>, the local time zone is used.</param>
    /// <returns>A new <see cref="DateTime"/> value representing the same point in time as the original nullable <see cref="DateTime"/> value, but converted to a different time zone.</returns>
    public static DateTime ChangeTimeZone(this DateTime? dt, int? tzSrc, int? tzDst) => dt.HasValue ? dt.Value.ChangeTimeZone(tzSrc, tzDst) : Today;
    ...
    /// If the original nullable <see cref="DateTime"/> value is <see langword="null"/>, the method returns the current date, converted to the time zone specified by the <paramref name="tzDst"/> parameter. If the <paramref name="tzDst"/> parameter is <see langword="null"/>, a time zone offset of 0 is used.
    /// </summary>
    /// <param name="dt">The nullable <see cref="DateTime"/> value to convert.</param>
