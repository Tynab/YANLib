...
public static partial class YANDateTime
{
    ...
    public static DateTime GenRandomDateTime(DateTime? min, DateTime max) => min.HasValue ? GenRandomDateTime(min.Value, max) : default;
    ...
    /// <param name="max">The maximum <see cref="DateTime"/> value.</param>
    /// <returns>A random <see cref="DateTime"/> value between <paramref name="min"/> and <paramref name="max"/>.</returns>
    public static DateTime GenRandomDateTime(DateTime min, DateTime? max) => max.HasValue ? GenRandomDateTime(min, max.Value) : default;
    ...
    public static DateTime GenRandomDateTime(DateTime? max) => max.HasValue ? GenRandomDateTime(max.Value) : default;
