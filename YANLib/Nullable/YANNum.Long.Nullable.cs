...
public partial class YANNum
{
    ...
    /// Returns the parsed <see cref="long"/> value, or the default value <paramref name="dfltVal"/> if the parsing fails.
    /// </summary>
    ...
    public static long? ToLong(this string str, long? dfltVal) => long.TryParse(str, out var num) ? num : dfltVal;
    ...
    public static long? GenRandomLong(long? min, long max) => min.HasValue ? YANLib.YANNum.GenRandomLong(min.Value, max) : null;
    ...
    public static long? GenRandomLong(long min, long? max) => max.HasValue ? YANLib.YANNum.GenRandomLong(min, max.Value) : null;
    ...
    /// If <paramref name="max"/> is <see langword="null"/>, <see cref="long.MaxValue"/> is used.
    /// </summary>
    /// <param name="max">The maximum <see cref="long"/> value.</param>
    ...
    public static long? GenRandomLong(long? max) => max.HasValue ? YANLib.YANNum.GenRandomLong(long.MinValue, max.Value) : null;
}
