...
{
    /// <summary>
    /// Parses the string representation of an integer using the default format. Returns the parsed <see cref="nint"/> value, or the default value <paramref name="dfltVal"/> if the parsing fails.
    /// </summary>
    ...
    /// <summary>
    /// Generates a random nullable <see cref="nint"/> value between <paramref name="min"/> and <paramref name="max"/>. If <paramref name="min"/> is greater than <paramref name="max"/> or <paramref name="min"/> is <see langword="null"/>, <see langword="null"/> is returned.
    /// </summary>
    ...
    /// <summary>
    /// Generates a random nullable <see cref="nint"/> value between <paramref name="min"/> and <paramref name="max"/>. If <paramref name="max"/> is <see langword="null"/>, <see langword="null"/> is returned.
    /// </summary>
    /// <param name="min">The minimum <see cref="nint"/> value.</param>
    /// <param name="max">The maximum <see cref="nint"/> value.</param>
    ...
    /// <summary>
    /// Generates a random <see cref="nint"/> value between <see cref="nint.MinValue"/> and <paramref name="max"/>. If <paramref name="max"/> is <see langword="null"/>, <see cref="nint.MaxValue"/> is used.
    /// </summary>
    /// <param name="max">The maximum <see cref="nint"/> value.</param>
