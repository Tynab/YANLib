...
public partial class YANNum
{
    ...
    public static sbyte? ToSbyte(this string str, sbyte? dfltVal) => sbyte.TryParse(str, out var num) ? num : dfltVal;
    ...
    public static sbyte? GenRandomSbyte(sbyte? min, sbyte max) => min.HasValue ? YANLib.YANNum.GenRandomSbyte(min.Value, max) : null;
    ...
    public static sbyte? GenRandomSbyte(sbyte min, sbyte? max) => max.HasValue ? YANLib.YANNum.GenRandomSbyte(min, max.Value) : null;
    ...
    public static sbyte? GenRandomSbyte(sbyte? max) => max.HasValue ? YANLib.YANNum.GenRandomSbyte(sbyte.MinValue, max.Value) : null;
}
