...
public partial class YANNum
{
    ...
    public static float? RandomNumberFloat(float? min, float max) => min.HasValue ? YANLib.YANNum.GenRandomFloat(min.Value, max) : null;
    ...
    public static float? RandomNumberFloat(float min, float? max) => max.HasValue ? YANLib.YANNum.GenRandomFloat(min, max.Value) : null;
    ...
    public static float? RandomNumberFloat(float? max) => max.HasValue ? YANLib.YANNum.GenRandomFloat(float.MinValue, max.Value) : null;
}
