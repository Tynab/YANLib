...
public partial class YANNum
{
    ...
    public static float? ToFloat(this string str, float? dfltVal) => float.TryParse(str, out var num) ? num : dfltVal;
    ...
    public static float? GenRandomFloat(float? min, float max) => min.HasValue ? YANLib.YANNum.GenRandomFloat(min.Value, max) : null;
    ...
    public static float? GenRandomFloat(float min, float? max) => max.HasValue ? YANLib.YANNum.GenRandomFloat(min, max.Value) : null;
    ...
    public static float? GenRandomFloat(float? max) => max.HasValue ? YANLib.YANNum.GenRandomFloat(float.MinValue, max.Value) : null;
}
