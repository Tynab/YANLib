...
public static partial class YANNum
{
    ...
    public static ushort? ToUshort(this string str, ushort? dfltVal) => ushort.TryParse(str, out var num) ? num : dfltVal;
    ...
    public static ushort? GenRandomUshort(ushort? min, ushort max) => min.HasValue ? YANLib.YANNum.GenRandomUshort(min.Value, max) : null;
    ...
    public static ushort? GenRandomUshort(ushort min, ushort? max) => max.HasValue ? YANLib.YANNum.GenRandomUshort(min, max.Value) : null;
    ...
    public static ushort? GenRandomUshort(ushort? max) => max.HasValue ? YANLib.YANNum.GenRandomUshort(ushort.MinValue, max.Value) : null;
}
