...
{
    /// <summary>
    /// Parses the string representation of a decimal using the default format. Returns the parsed <see cref="decimal"/> value, or <see langword="null"/> if the parsing fails.
    /// </summary>
