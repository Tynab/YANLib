...
{
    /// <summary>
    /// Parses the string representation of a double using the default format. Returns the parsed <see cref="double"/> value, or <see langword="null"/> if the parsing fails.
    /// </summary>
